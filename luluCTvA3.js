javascript:(async function() {
    const API_URL = "https://script.google.com/macros/s/AKfycbxPcul5j1PmVbd93SaHkReJfzgqhdiPDfXOTt34y-ZGqyre0Q8Z3yF2g0TkqTOzk4nA/exec";
    ...
    const processToMatrix = (rawData) => {
     ...
     // ✅ NEW: Smart Upload Function
    const uploadMatrixData = async (data) => {
        const payload = JSON.stringify(data);
        const MAX_CHUNK_SIZE = 200 * 1024;

        console.log("Payload size KB:", (payload.length / 1024).toFixed(2));
        ...
        for (let i = 0; i < chunks.length; i++) {
            ...
            while (retries--) {
                try {
                    ...
                    console.log(`Chunk ${i+1}:`, await res.text());
                    break;
